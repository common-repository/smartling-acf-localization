 ...
 */
class AcfOptionEntity extends \Smartling\DbAl\WordpressContentEntities\VirtualEntityAbstract
{
    /**
     * @var \Smartling\DbAl\SmartlingToCMSDatabaseAccessWrapperInterface
     */
    private $dbal;
    ...
    {
        $block = \Smartling\Helpers\QueryBuilder\Condition\ConditionBlock::getConditionBlock();
        $condition = \Smartling\Helpers\QueryBuilder\Condition\Condition::getCondition(
            \Smartling\Helpers\QueryBuilder\Condition\ConditionBuilder::CONDITION_SIGN_LIKE,
            'option_name',
            ['options_%']
        );
        $block->addCondition($condition);
        $query = \Smartling\Helpers\QueryBuilder\QueryBuilder::buildSelectQuery(
     ...
     * @return mixed
     */
    public function set(\Smartling\DbAl\WordpressContentEntities\EntityAbstract $entity = null)
    {
